    ...
    <div className="min-h-screen bg-gray-50 flex" style={{ flexDirection: isDesktop ? 'row' : 'column' }}>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-sm">
          ...
          {!isDesktop && (
            <div className="w-full bg-gray-900 px-6 py-5 mb-8 -mx-6 -mt-10" style={{ marginLeft: '-24px', marginRight: '-24px', marginTop: '-40px', width: 'calc(100% + 48px)' }}>
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 bg-white/10 rounded-xl flex items-center justify-center">
                  <span className="text-white text-sm font-black">B</span>
                </div>
              ...
              <p className="text-gray-400 text-xs mt-1">Gérez votre argent simplement</p>
            </div>
          )}
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className={labelCls} style={{ marginBottom: 0 }}>Mot de passe</label>
